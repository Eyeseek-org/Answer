      ...
      <>
        {active === act ? (
          <Active>
            {text === 'Classic' && (
              <ActBox>
                <RewardActiveIcon width={120} height={100} />
              </ActBox>
            )}
            {text === 'ERC20' && (
              <ActBox>
                <Erc20ActiveIcon width={120} />
              </ActBox>
            )}
            {text === 'ERC1155' && (
              <ActBox>
                <NftActiveIcon width={120} height={110} />
              </ActBox>
            )}
          ...
          <Inactive onClick={onClick}>
            {text === 'Classic' && (
              <IconBox>
                <RewardIcon width={120} height={100} />
              </IconBox>
            )}
            {text === 'ERC20' && (
              <IconBox>
    ...
    <Container>
      ...
      {o3 && (
        <>
          {' '}
          <Divider />
          <Item act={o3} o={o3} text={o3} onClick={change3} />
        </>
      )}
      {o4 && (
        <>
          {' '}
          <Divider />
          <Item act={o4} o={o4} text={o4} onClick={change4} />
        </>
      )}
      {o5 && (
        <>
          {' '}
          <Divider />
          <Item act={o5} o={o5} text={o5} onClick={change5} />
        </>
      )}
    </Container>
  );
