...
const Stream = ({ objectId, recipient }) => {
  ...
  const addStreamState = async (oid) => {
    try {
      await axios.post(
        `${process.env.NEXT_PUBLIC_DAPP}/classes/Stream`,
        {
          projectId: oid,
          flowRate: flowRate,
          ...
          {newStream ? (
            <>
              ...
              <ValueRow>
                ...
                <RowItem>
                  <ActiveValue>
                    <Address address={'0xcfA132E353cB4E398080B9700609bb008eceB125'} />
                  </ActiveValue>
                </RowItem>
              ...
              <ButtonBox>
                <ApproveUniversal
                  tokenContract={'0x5D8B4C2554aeB7e86F387B4d6c00Ac33499Ed01f'}
                  spender={'0xcfA132E353cB4E398080B9700609bb008eceB125'}
                  amount={flowRate}
                />
                <ButtonAlt width={'100px'} text="Start" onClick={() => startStream()} />
              </ButtonBox>
              ...
              {streamFound ? (
                <>
                  ...
                  <ValueRow>
                    ...
                    <RowItem>
                      <ActiveValue>
                        <StreamCounter startValue={deposit} endValue={displayRate} />
                      </ActiveValue>
                    </RowItem>
                ...
                <>
                  <Title>
                    <Subtitle text={'No active stream found'} />
                  </Title>
                  <ButtonBox>
                    <ButtonAlt
                      width={'100%'}
