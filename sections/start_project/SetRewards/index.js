  ...
  return (<>
    ...
    <MainContainer>
      ...
      {rewardsCounts > 0 &&    <ButtonBox>
          ...
          <RewardButton onClick={() => handleRemoveReward()}><RewardAction>Remove last reward </RewardAction><RemoveIcon width={20} height={20}/></RewardButton>
        </ButtonBox>}
