...
const Texts = {
  ...
  description1:
    'No matter from which chain backers donate, thanks to the Axelar Network, total amount will sum up across all. Currently supported backing from Polygon, BNB Chain, Fantom.',
  title2: 'Microfunds',
  description2:
    'Backers can deploy microfunds instead of classic donations and each time someone after donates, the same amount is charged from all microfunds until they are depleted. With good strategy even $1 donation could have $100 impact.',
  title3: 'Cheapest crowdfunding around',
  description3:
    'Our infrastructure is powered by blockchain smart contracts, the infrastructure is much more cheaper than traditional crowdfunding companies like Kickstarter, which takes 5% platform fee for successful projects.',
  title4: 'Money streaming',
  description4:
    'Already started project and need long-term support? Create a funding type using our crypto payment streaming, backers can flow resources real-time and turn on/off the streams based on your delivery.',
  title5: 'Rewards',
};
...
const MicroDescription = () => {
  return (
    <>
      With <B>chain funding</B> capacities of Eyeseek microfunds, each time someone donates, the same amount is charged from all deployed
...
const FeeDescription = () => {
  return (
    <>
      Our infrastructure is powered by blockchain smart contracts, which is more lightweight than{' '}
...
const StreamDescription = () => {
  return (
    <>
      Already started project and need long-term support? Use our <G>crypto payment streaming</G>, backers can flow resources real-time and
...
const RewardDescription = () => {
  return (
    <>
      Reward your backers with unique <F>NFT collections</F> or <F>in-game blockchain items</F>. We support reward distributuon of{' '}
