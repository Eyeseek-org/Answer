...
const Features = () => {
    ...
    return <Container>
        ...
        <ContentBox>
            <Row>
                {demoMicro ? <FeatureCard icon={<BlockchainIcon width={55} />} title={Texts.title1} description={<Image unoptimized={true}  src={cross} width={500} height={300} />} onClick={() => { setDemoMicro(!demoMicro) }} /> :
                    <FeatureCard icon={<BlockchainIcon width={55} />} title={Texts.title1} description={<CrossDescription />} onClick={() => { setDemoMicro(!demoMicro) }} />}

                {demoFunding ? <FeatureCard icon={<MicrofundIcon width={55} />} title={Texts.title2} description={<Image unoptimized={true} src={chaindonation} width={500} height={300} />} onClick={() => { setDemoFunding(!demoFunding) }} /> :
            ...
            <Row>
                {demoFee ? <FeatureCard icon={<PiggyIcon width={55} />} title={Texts.title3} description={<Image unoptimized={true}  src={fee} width={500} height={300}/>} onClick={() => { setDemoFee(!demoFee) }} /> :
