...
import { EvmChain, GasToken, AxelarQueryAPI, AxelarGMPRecoveryAPI, Environment } from '@axelar-network/axelarjs-sdk';
...
const Cross: NextPage = () => {
  ...
  // encoding a string
  const payload = ethers.utils.defaultAbiCoder.encode(['string'], ['Hello from contract A']);
  ...
  return (
    <>
      ...
      <div>
        ...
        <input disabled={loading} required name="amount" type="number" placeholder="Enter amount to send" />
      </div>
    </>
  );
};
